...
const WEBHOOK_URL = 'https://webhook.cursoentropia.com/webhook/viradoespapai';
...
function showGreetingPage(firstName = null) {
    ...
    if (firstName) {
        ...
        // Se API não retornou dados, mostrar apenas "Olá"
        greetingText.textContent = 'Olá';
    }

    // Mostrar a página de saudação
    showStep('step-2');

    // Após 3 segundos, ir para seleção de viradões
    setTimeout(() => {
        showStep('step-3');
    }, 3000);
}
